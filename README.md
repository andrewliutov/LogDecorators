* Логирующий [декоратор](1_decorator.py), записывающий в файл `log.txt` дату и время вызова функции, имя функции, аргументы, с которыми вызвалась, и возвращаемое значение.
